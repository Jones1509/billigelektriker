...
export const ProductCategories = () => {
  ...
  return (
    <section className="py-6 md:py-12 relative overflow-hidden" style={{ background: 'linear-gradient(180deg, hsl(var(--background)) 0%, hsl(var(--blue-tint) / 0.3) 50%, hsl(var(--blue-tint)) 100%)' }}>
      {/* Smooth top fade */}
