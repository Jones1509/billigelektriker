  ...
  return (
    <div className="hidden md:block bg-gradient-to-r from-[#0A1628] via-[#0d1d35] to-[#0A1628] border-b border-white/10 shadow-lg overflow-hidden">
      <div className="container">
        <div className="flex items-center justify-between h-11 md:h-12 lg:h-14 text-sm px-2 md:px-0">
          {/* Left side - Gratis fragt */}
          <div className="flex items-center gap-1.5 md:gap-2 text-white group whitespace-nowrap flex-shrink-0">
            <Zap className="h-3.5 w-3.5 md:h-4 md:w-4 text-secondary group-hover:scale-110 transition-transform duration-300" />
          ...
          <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
            ...
            <a 
              href="tel:+4512345678"
              className="flex items-center gap-1 md:gap-1.5 lg:gap-2 text-white/90 hover:text-white transition-all duration-300 ease-in-out group relative whitespace-nowrap"
            >
              <Phone className="h-3.5 w-3.5 md:h-4 md:w-4 group-hover:scale-105 transition-all duration-300" />
              <span className="text-[10px] md:text-xs font-medium">+45 12 34 56 78</span>
            </a>
