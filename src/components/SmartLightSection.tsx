      ...
      <div className="container relative z-10">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-6 order-1 md:order-2 animate-fade-in">
            ...
            <div className="flex items-start gap-4 p-6 bg-gradient-to-br from-white to-purple-50/30 dark:from-gray-900 dark:to-purple-950/20 rounded-2xl border border-purple-500/10 shadow-lg">
              <div className="p-3 bg-gradient-to-br from-primary to-purple-600 rounded-xl shadow-lg flex-shrink-0">
                <Shield className="h-6 w-6 text-white" />
              </div>
              <div>
                <div className="font-semibold mb-1">Tryg installation</div>
