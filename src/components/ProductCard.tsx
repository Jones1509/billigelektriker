...
export const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <>
      ...
      <Card className="group overflow-hidden border border-border/60 rounded-2xl h-full flex flex-col transition-all duration-300 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1">
