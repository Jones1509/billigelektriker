...
export const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <>
      ...
      <Card className="product-card group overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-1 border border-border rounded-2xl h-full flex flex-col">
