        ...
        <div className="border-t border-slate-200 pt-6 bg-slate-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 -mb-12 pb-6">
          <div className="flex flex-col md:flex-row justify-center items-center gap-3 text-slate-600">
            ...
            <div className="flex flex-wrap justify-center gap-5">
              <a href="#" className="hover:text-blue-600 transition-all duration-200 text-xs font-medium hover:underline underline-offset-4">
                Privatlivspolitik
              </a>
              <a href="#" className="hover:text-blue-600 transition-all duration-200 text-xs font-medium hover:underline underline-offset-4">
                Handelsbetingelser
              </a>
              <Link to="/kontakt" className="hover:text-blue-600 transition-all duration-200 text-xs font-medium hover:underline underline-offset-4">
                Kontakt
              </Link>
            </div>
          </div>
