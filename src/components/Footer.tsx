            ...
            <div className="flex items-center gap-4 flex-wrap justify-center">
              ...
              <div className="flex items-center gap-2">
                <div className="relative group cursor-pointer">
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-blue-400 rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-300"></div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-red-400 rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-300"></div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="absolute -inset-1 bg-gradient-to-r from-green-600 to-blue-500 rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-300"></div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="absolute -inset-1 bg-gradient-to-r from-pink-600 to-pink-400 rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-300"></div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 to-red-500 rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-300"></div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="absolute -inset-1 bg-gradient-to-r from-blue-700 to-blue-500 rounded-xl opacity-0 group-hover:opacity-75 blur transition duration-300"></div>
