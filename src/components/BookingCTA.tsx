...
export const BookingCTA = () => {
  return (
    <section className="py-24 bg-gradient-to-br from-background via-blue-50/30 to-background relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 shadow-2xl bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-900 dark:to-blue-950/30 overflow-hidden">
            ...
            <CardContent className="relative p-12 text-center space-y-8">
              <div className="inline-flex p-6 bg-gradient-to-br from-primary to-blue-600 rounded-2xl shadow-xl">
