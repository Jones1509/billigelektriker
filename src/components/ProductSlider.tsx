      ...
      <div className="carousel-inner-wrapper">
        ...
        <div className="text-center mb-8 md:mb-10 animate-fade-in">
          ...
          <nav aria-label="Produktfiltre">
            <div className="inline-flex items-center justify-center gap-1.5 sm:gap-2 p-1.5 mb-10 md:mb-5 rounded-full relative z-[1]" style={{ background: '#F3F4F6' }} role="tablist">
              <button
