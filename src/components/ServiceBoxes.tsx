...
export const ServiceBoxes = () => {
  return (
    <section className="py-24 bg-gradient-to-b from-background via-blue-50/30 to-background relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="group relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-white to-blue-50/50 dark:from-gray-900 dark:to-blue-950/30">
            ...
            <CardContent className="relative p-10 md:p-14 flex flex-col items-start h-full">
              <div className="mb-8 p-5 bg-gradient-to-br from-primary to-blue-600 rounded-2xl shadow-lg group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
          ...
          <Card className="group relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-gradient-to-br from-white to-green-50/50 dark:from-gray-900 dark:to-green-950/30">
            ...
            <CardContent className="relative p-10 md:p-14 flex flex-col items-start h-full">
              <div className="mb-8 p-5 bg-gradient-to-br from-secondary to-green-600 rounded-2xl shadow-lg group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
                <ShoppingBag className="h-10 w-10 text-white" />
              </div>
              <h3 className="text-3xl md:text-4xl font-bold mb-4 group-hover:text-secondary transition-colors">
                El-produkter
              </h3>
              <p className="text-muted-foreground text-lg mb-8 flex-grow leading-relaxed">
