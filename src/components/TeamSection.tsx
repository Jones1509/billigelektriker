...
export const TeamSection = () => {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-background via-blue-50/30 to-green-50/20 dark:from-gray-950 dark:via-blue-950/20 dark:to-green-950/10"></div>
